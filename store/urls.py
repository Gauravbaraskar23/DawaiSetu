...
from store.views import  landing_page, seller_dashboard, add_medicine, store_home, medicine_detail, edit_medicine, delete_medicine, upload_medicine_image, bulk_upload_medicines, manage_staff, delete_staff, toggle_staff_status, store_analytics
